...
/** Ogohlantirish (Alert / warning) */
export const IconAlertTriangle = ({ size = 16 }: P) => (
  <svg {...base(size)}>
...
/** Buyurtma (So'rov blankasi / Change Request) */
export const IconOrder = ({ size = 16 }: P) => (
  <svg {...base(size)}>
...
/** Qog'oz qisqichi (Paperclip / Attachment) */
...
/** Rasmni kattalashtirish (Zoom In) */
export const IconZoomIn = ({ size = 16 }: P) => (
  <svg {...base(size)}>
...
/** Rasmni kichraytirish / asl o'lchamga qaytarish (Zoom Out) */
export const IconZoomOut = ({ size = 16 }: P) => (
  <svg {...base(size)}>
    <circle cx="11" cy="11" r="7" />
    <line x1="21" y1="21" x2="16.65" y2="16.65" />
    <line x1="8" y1="11" x2="14" y2="11" />
